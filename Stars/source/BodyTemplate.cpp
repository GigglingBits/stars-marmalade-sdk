...
void BodyTemplate::Set(const std::string& id, const std::string& type, const std::string& shape, const std::string& fixture, const std::string& texture) {
	...
	if (!type.compare("dynamic") || !type.compare("star") || !type.compare("nugget") || !type.compare("nugget2") || !type.compare("nugget3") || !type.compare("nugget4") || !type.compare("enemy") || !type.compare("bird") || !type.compare("bird_ripper") || !type.compare("bird_screecher") || !type.compare("grunt") || !type.compare("grunt_bully") || !type.compare("grunt_gunner") || !type.compare("grunt_ufo")) {
